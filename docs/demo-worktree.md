...
git init
git config user.email opencode@example.test
...
/path/to/opencode/dist/cli/index.js team run "explain repo" --workspace git-worktree
/path/to/opencode/dist/cli/index.js team workspaces
```
